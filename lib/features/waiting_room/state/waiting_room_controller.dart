...
import 'package:werewolf/screens/play_screen.dart';
...
class WaitingRoomController extends GetxController {
  ...
  var isHost =
      false.obs; // Xác định xem người dùng hiện tại có phải chủ phòng không
  ...
  void startGame() {
    ...
    if (players.length < 5) {
      ...
      // THÊM DÒNG NÀY ĐỂ NHẢY VÀO MÀN HÌNH CHƠI CỦA VINH/HÙNG:
